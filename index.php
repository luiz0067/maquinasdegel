    ...
    <div id="principal">
      <?php 
		...
		if($pg=="home")
			...
			else if($pg=="maqgelo21")
			include('maqgelo21.php');
			
			else if($pg=="maqgelo22")
			include('maqgelo22.php');
			
			else if($pg=="maqgelo23")
			include('maqgelo23.php');
			
			else if($pg=="maqgelo24")
			include('maqgelo24.php');
			
			else if($pg=="maqgelo25")
			include('maqgelo25.php');
			
			else if($pg=="maqgelo26")
			include('maqgelo26.php');
			
			else if($pg=="maqgelo27")
			include('maqgelo27.php');
		else
			include('home.php');
	?>
    </div>
